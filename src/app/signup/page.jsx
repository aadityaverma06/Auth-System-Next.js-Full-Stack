  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 text-3xl">
      ...
      <div className="mt-10 flex flex-col items-center justify-center py-2 text-2xl gap-3">
        ...
        <Link
          className="flex gap-2 items-center justify-center  text-white bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg px-3 py-1.5 dark:bg-pink-700 mb-2 dark:hover:bg-pink-800 focus:outline-none dark:focus:ring-pink-900 cursor-pointer w-full text-center transition duration-200"
          href="/login"
        >
          <IconLogin2 size={25} />
          Login
        ...
        <button
          type="button"
          className="text-white flex gap-2 items-center justify-center bg-pink-600 hover:bg-pink-700 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg px-3 py-1.5 mb-4 dark:bg-pink-700 dark:hover:bg-pink-800 focus:outline-none dark:focus:ring-pink-900 cursor-pointer w-full disabled:cursor-not-allowed disabled:opacity-50 transition duration-200"
          onClick={onHome}
        >
          <IconHome size={25} />
          Home
